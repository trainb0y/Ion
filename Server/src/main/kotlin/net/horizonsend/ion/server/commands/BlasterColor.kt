...
class BlasterColor : BaseCommand() {
	...
	fun onBlasterColorCommand(player: Player) {
		...
		player.sendFeedbackMessage(FeedbackType.SUCCESS, "Reset blaster colour to default.")
	}
	...
	fun onBlasterColorCommand(player: Player, red: Int, green: Int, blue: Int) {
		...
		player.sendFeedbackMessage(FeedbackType.SUCCESS, "Set blaster colour to $red, $green, $blue.")
	}
}